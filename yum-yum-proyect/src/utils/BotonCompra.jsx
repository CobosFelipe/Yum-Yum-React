...
const BotonCompra = ({to, className, children}) => {
  return (
    <div className="flex w-full justify-center">
      <Link
        to={to}
        className={`relative inline-flex items-center justify-center px-4 py-2 overflow-hidden tracking-tighter text-lg font-semibold text-white capitalize bg-gray-800 rounded-md group transition-transform duration-200 active:translate-y-1 ${className}`}
      >
