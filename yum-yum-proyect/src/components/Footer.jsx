    ...
    <>
      <footer className="bg-white">
        <div className="container px-6 py-8 mx-auto">
          ...
          <div className="flex flex-col items-center flex-col sm:justify-between">
            <div className="flex flex-row gap-2 sx:flex-col text-center">
              <p className="text-md text-gray-500 font-normal cursor-pointer  ">© Copyright 2024. All Rights Reserved.</p>
              <p className="text-md text-gray-500 font-normal cursor-pointer  ">Dev with ❤ by Sense8.</p>
            </div>

            <div className="flex -mx-2">
              <a
                href="https://api.whatsapp.com/message/6M4LB3XJPB7EB1?autoload=1&amp;app_absent=0"
                className="mx-2 text-gray-500 font-normal cursor-pointer  transition-colors duration-300 hover:text-pink-400"
                target="_blank"
              ></a>
